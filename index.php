<?php 
// ==========================================
// 1. BACKEND LOGIC & MULTI-LANGUAGE
// ==========================================
...
// B. TEXT MAPPING (PROFESIONAL VERSION)
$txt = [
...
// Trik untuk bikin enter otomatis setelah tanda | 
...
<body class="antialiased selection:bg-accent selection:text-white relative">
        ...
        <div class="max-w-7xl mx-auto px-6 w-full relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm text-secondary text-[10px] font-bold uppercase tracking-widest mb-8 -mt-40 md:-mt-32">
                    ...
                    <div class="mb-6">
                        <h2 class="text-2xl md:text-3xl font-bold mb-4"> <span class="text-accent"><?php echo $txt['greeting_pre']; ?></span> <span class="text-primary">Ferry Fernando</span>,
                        </h2>
                    ...
                    <div class="flex gap-6 mb-10 border-l-4 border-accent/20 pl-6">
                        <p class="text-lg text-gray-600 leading-relaxed max-w-lg font-medium">
                            <?php echo $hero_desc; ?>
                        </p>
                    </div>
                    
                    <div class="flex flex-wrap gap-4">
                        <a href="#projects" class="bg-primary text-white px-8 py-3.5 rounded-full font-bold text-sm hover:bg-accent transition shadow-lg hover:shadow-glow hover:-translate-y-1">
                            <?php echo $txt['btn_port']; ?>
                        </a>
                        <a href="<?php echo $cv_url; ?>" target="_blank" class="bg-white text-primary border border-gray-200 px-8 py-3.5 rounded-full font-bold text-sm hover:bg-gray-50 transition shadow-sm hover:-translate-y-1">
                            <?php echo $txt['btn_cv']; ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="island-box">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="group p-8 rounded-3xl bg-gray-50 hover:bg-primary hover:text-white transition duration-500 cursor-default h-full flex flex-col">
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-xl text-accent mb-6 shadow-sm group-hover:scale-110 transition">
                    ...
                    <div class="flex flex-wrap gap-2 mt-auto">
                        ...
                        <span class="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-gray-200 text-[10px] font-bold text-gray-700 shadow-sm group-hover:bg-white/10 group-hover:text-white group-hover:border-white/30 transition-all">
                ...
                <div class="group p-8 rounded-3xl bg-gray-50 hover:bg-primary hover:text-white transition duration-500 cursor-default h-full flex flex-col">
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-xl text-green-500 mb-6 shadow-sm group-hover:scale-110 transition">
                ...
                <div class="group p-8 rounded-3xl bg-gray-50 hover:bg-primary hover:text-white transition duration-500 cursor-default h-full flex flex-col">
                    <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-xl text-purple-500 mb-6 shadow-sm group-hover:scale-110 transition">
    ...
    <section id="about" class="py-24 max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 sticky top-10" data-aos="fade-right">
                ...
                <h2 class="text-4xl md:text-5xl font-black text-primary leading-tight mb-8">
            ...
            <div class="lg:col-span-7 lg:pt-4" data-aos="fade-left">
                <h3 class="text-2xl md:text-3xl font-bold text-gray-700 leading-relaxed mb-12">
                    <?php echo $about_text; ?>
                </h3>

                <div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-glass border border-white/60">
                    <h4 class="text-xl font-black mb-10 flex items-center gap-3">
                    ...
                    <div class="timeline-container">
                        ...
                        <div class="timeline-item group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                                ...
                                <span class="text-xs font-bold bg-gray-100 text-gray-600 px-3 py-1 rounded-full mt-1 sm:mt-0 w-fit">
                                    <?php echo $row['year']; ?>
                                </span>
                            </div>
                            
                            <div class="text-sm font-bold text-accent mb-3 uppercase tracking-wider">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                ...
                <div class="group cursor-pointer" onclick="openModal('<?php echo clean($d['title']);?>', '<?php echo clean($d['description']);?>', 'assets/img/<?php echo $d['image'];?>', '<?php echo clean($d['link_demo']);?>')">
                    ...
                    <div class="flex justify-between items-start px-2">
                        ...
                        <div class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-black transition">
    ...
    <section id="contact" class="py-32 text-center relative overflow-hidden" data-aos="zoom-in">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10">
            <h2 class="text-5xl md:text-7xl font-black text-primary mb-8 tracking-tight leading-tight">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-accent to-purple-600"><?php echo $txt['sect_contact_2']; ?></span>
            </h2>
            <p class="text-xl text-gray-500 mb-12 max-w-xl mx-auto leading-relaxed">
                <?php echo $txt['contact_sub']; ?>
            </p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="mailto:<?php echo $p['email']; ?>" class="bg-primary text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-accent transition shadow-xl hover:shadow-glow hover:-translate-y-1">
                    <?php echo $txt['btn_email']; ?>
                </a>
                <a href="https://wa.me/<?php echo $p['whatsapp']; ?>" target="_blank" class="bg-white text-primary border border-gray-200 px-10 py-5 rounded-full font-bold text-lg hover:bg-gray-50 transition shadow-md hover:-translate-y-1">
                    WhatsApp
                </a>
            </div>
        </div>
    ...
    <div class="fixed bottom-8 right-8 z-50 flex flex-col items-end">
        ...
        <div id="chatbotFrame" class="hidden fixed bottom-28 right-8 w-[90%] max-w-[400px] h-[500px] bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden z-10 animate-fadeInUp origin-bottom-right">
            ...
            <iframe src="apps/api/chat" class="w-full h-full border-0"></iframe>
        </div>
    </div>
