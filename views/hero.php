                ...
                <div data-aos="fade-right" data-aos-duration="1000" class="-mt-20 lg:-mt-32 order-2 lg:order-1">
                    ...
                    <div class="mb-6">
                        <h2 class="text-2xl md:text-3xl font-bold mb-4"> 
                            ...
                            <span class="text-primary"><?php echo $hero_greet; ?></span>,
                        </h2>
                        ...
                        <div class="relative w-full z-10">
                            ...
                            <div class="absolute top-4 -right-2 flex flex-col gap-3 z-20 scale-90">
                                ...
                                <div class="w-16 h-16 bg-white rounded-full shadow-lg flex flex-col items-center justify-center border border-gray-100 animate-[bounce_4s_infinite] p-1">
                                    ...
                                    <span class="text-[7px] font-bold text-primary uppercase text-center leading-tight">Available<br>For Hire</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative w-full max-w-md z-10">
                        ...
                        <div class="absolute top-10 right-6 flex flex-col gap-4 z-20">
                            ...
                            <div class="w-24 h-24 bg-white rounded-full shadow-xl flex flex-col items-center justify-center border border-gray-100 animate-[bounce_3s_infinite] p-2">
                                ...
                                <span class="text-[9px] font-bold text-gray-400 uppercase text-center leading-none">
                            ...
                            <div class="w-24 h-24 bg-white rounded-full shadow-xl flex flex-col items-center justify-center border border-gray-100 animate-[bounce_4s_infinite] p-2">
                                <div class="w-3 h-3 bg-green-500 rounded-full mb-1 animate-pulse"></div>
                                <span class="text-[9px] font-bold text-primary uppercase text-center leading-none">
