    ...
    public function postGR($data) {
        try {
            ...
            while($left > 0.0001) {
                ...
                $hu_id = "HU" . strtoupper(substr(md5(uniqid("", true)), 0, 10));
            ...
            if($total_bad > 0) {
                $hu_bad = "DMG" . strtoupper(substr(md5(uniqid("", true)), 0, 8));
...
<head>
    <meta charset="UTF-8">
    <title>Inbound Control | Smart WMS</title>
    ...
    <div class="app-sidebar">
        <div class="sidebar-brand">
            <div class="d-flex align-items-center gap-3">
                ...
                <div><h5 class="fw-bold m-0">Enterprise Inbound</h5><span class="text-muted small">Warehouse Management System</span></div>
            </div>
