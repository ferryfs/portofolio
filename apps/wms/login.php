...
<head>
    ...
    <style>
        ...
        .btn-login {
            ...
            font-weight: 700; font-size: 1rem; letter-spacing: 0.5px; transition: 0.3s;
            margin-top: 10px; box-shadow: 0 10px 20px -5px rgba(0, 86, 210, 0.3);
        }
        ...
        .btn-demo {
            background: #e0f2fe; color: #0284c7; border: 1px dashed #0284c7;
            font-weight: 700; font-size: 0.75rem; padding: 8px 15px; border-radius: 50px; cursor: pointer; transition: 0.2s;
        }
        .btn-demo:hover { background: #bae6fd; transform: scale(1.02); }

        .copyright-text { font-size: 0.75rem; color: #94a3b8; margin-top: 30px; padding-top: 20px; border-top: 1px solid #f1f5f9; text-align: center; }
    </style>
</head>
<body>
    ...
    <div class="login-card">
        ...
        <form action="auth.php" method="POST">
            ...
            <button type="submit" name="btn_login" id="btnLogin" class="btn btn-primary w-100 btn-login">
