...
<head>
    ...
    <style>
        ...
        .sign-title { font-size: 10pt; font-style: italic; }

        /* STAMP APPROVED */
        .stamp {
            position: absolute; right: 20px; top: 150px;
            border: 3px solid #28a745; color: #28a745;
            padding: 10px 20px; font-size: 20pt; font-weight: bold;
...
<body onload="window.print()">
    ...
    <div class="container">
        ...
        <table class="table-info">
            <tr><td class="label">To</td><td class="colon">:</td><td>Finance Dept, Supply Chain, All Sales Team</td></tr>
            <tr><td class="label">From</td><td class="colon">:</td><td>Trade Marketing Dept</td></tr>
            <tr><td class="label">Date</td><td class="colon">:</td><td><?php echo date('d F Y', strtotime($d['created_at'])); ?></td></tr>
            <tr><td class="label">Ref No</td><td class="colon">:</td><td><?php echo $d['sb_number']; ?> / <?php echo $d['ref_number'] ?: '-'; ?></td></tr>
            <tr><td class="label">Subject</td><td class="colon">:</td><td><strong><?php echo $d['promo_name']; ?></strong></td></tr>
        </table>
        ...
        <div class="content">
            ...
            <div style="margin-left: 20px; font-size: 11pt;">
                <?php echo $d['terms_conditions']; // HTML dari Summernote aman disini ?>
            </div>
        ...
        <div class="signature-box">
            <div class="sign-col">
                ...
                <div class="sign-name"><?php echo $d['created_by']; ?></div>
                <div class="sign-title">Trade Marketing</div>
            </div>
            ...
            <div class="sign-col">
                ...
                <div class="sign-title">Sales Manager</div>
            </div>

            <div class="sign-col">
                <div>Approved By,</div>
                <div class="sign-space"></div>
                <div class="sign-name">Haryanto</div>
                <div class="sign-title">Finance Director</div>
            </div>
        </div>
