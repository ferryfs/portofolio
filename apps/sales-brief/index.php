<?php
session_start();
// CEK KEAMANAN: Kalau belum login, tendang ke landing page
...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link font-weight-bold text-uppercase">
            <i class="fas fa-user"></i> &nbsp; <?php echo $_SESSION['sb_name']; ?> (<?php echo $_SESSION['sb_div']; ?>)
        </a>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link text-danger" href="auth.php?logout=true">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="#" class="brand-link">
      <span class="brand-text font-weight-light pl-3">SALES BRIEF APP</span>
    </a>
        ...
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
                <div class="mb-3 text-right">
                    <button class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Create New Sales Brief</button>
                </div>
