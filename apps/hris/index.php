...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            background: #1e293b; color: #adb5bd; padding-top: 20px;
            transition: all 0.3s;
        }
        .sidebar-brand {
            color: white; font-size: 1.5rem; font-weight: 800; text-align: center; margin-bottom: 30px;
        ...
        .nav-link {
            color: #adb5bd; padding: 12px 25px; text-decoration: none; display: flex; align-items: center;
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="#" class="nav-link"><i class="fa fa-chart-line"></i> KPI & Appraisal</a>
        <a href="#" class="nav-link"><i class="fa fa-chalkboard-user"></i> Training (LMS)</a>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div>
                ...
                <p class="text-muted mb-0">Selamat Datang, <?php echo $nama_admin; ?></p>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    <div>
                        <h6 class="text-muted mb-1">Payroll Bulan Ini</h6>
                        <h3 class="fw-bold mb-0 text-info">Rp 850M</h3>
                    </div>
